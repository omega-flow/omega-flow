...
description: Explains the workflow concepts, components, and architecture in a clear and concise manner. Use this skill to understand how workflows are structured, how they execute, and how different parts of the system interact with each other.
---
