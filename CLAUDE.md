...
For task-specific guidance on the editor package, use:

- `/localization` - Adding new UI strings and translations
- `/theming` - Adding or modifying CSS theme variables
